var messages = {
  ...
  document.getElementById("speech_button").addEventListener("click",function(){
    if(recognizing){
      recognizing=false
      recognition.stop();
    }
    Speak(final_span.innerText, select_language);
  })
  ...
  function Speak(text,selectlanguage){
    let newtext=new SpeechSynthesisUtterance();
    newtext.lang = selectlanguage;
    newtext.text=text;
    // newtext.voice=voice;
